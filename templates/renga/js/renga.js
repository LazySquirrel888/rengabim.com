    ...
    $("body").on("click","#full_view_model",function () {
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $('body').append(data);
                $('body').append('<div class="pp_default popup_project"><img class="cube" src="/templates/renga/img/round_cube.png"><div class="preview_work_ajax"><div id="loading"><img src="/templates/renga/img/ring_loader.gif"><span>Идет загрузка проекта...</span></div></div>' +
